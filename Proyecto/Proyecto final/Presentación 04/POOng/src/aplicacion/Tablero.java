...
public class Tablero extends JPanel{
	 ...
	 * Genera dos número aleatorios entre 0 y 499
	...
	/**
	 * Cuando es llamada, agrega al ArrayList de Bloques uno nuevo, en una ubicación aleatoria que depende de la dirección de la pelota
	 */
	...
	/**
	 * Añade 1 al contador usado para definir la imagen actual del campo de juego
	 */
	public void addCont() {
		cont++;
	}
