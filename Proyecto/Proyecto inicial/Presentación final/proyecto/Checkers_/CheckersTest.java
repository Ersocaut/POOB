...
public class CheckersTest
{
    ...
    @Test
    public void Probandoproletarian()
    {
        Checkers_.Checkers checkers1 = new Checkers_.Checkers(8);
        checkers1.addProle(true, 2, 1);
        checkers1.addProle(true, 7, 2);
        checkers1.swap();
        checkers1.move("5-1");
        checkers1.move("25-29");
    }

    @Test
    public void Probandolibertarian()
    {
        Checkers_.Checkers checkers1 = new Checkers_.Checkers(8);
        checkers1.addLibertarian(true, 2, 1);
        checkers1.add(false, 3, 2);
        checkers1.swap();
        checkers1.move("5x14");
    }

    @Test
    public void ProbandoStay()
    {
        Checkers_.Checkers checkers1 = new Checkers_.Checkers(8);
        checkers1.addStay(true, 6, 5);
        checkers1.add(true, 5, 4);
        checkers1.swap();
        checkers1.move("18x27");
        checkers1.move("23-19");
        checkers1.move("23-32");
    }
